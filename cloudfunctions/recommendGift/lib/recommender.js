const { GIFT_DIRECTIONS } = require("../data/giftDirections");

const RESULT_LIMIT = 24;
const SCHEMA_VERSION = "gift-backend-v1";
const QUESTIONNAIRE_VERSION = "2026-05-30-candidate-v2";
const MODEL_VERSION = "decision-table-v1";
...
function recommendGift(rawAnswers) {
